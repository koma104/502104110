...
const projects: Project[] = [
  {
    ...
    focus:
      '緊急時に最速でトイレにたどり着けるよう、操作数を最小化した設計を意識しました。起動直後に候補を表示し、迷わない導線構成にしています。',
    tags: ['React', 'Next.js'],
  },
  {
    title: 'A01',
    ...
    focus:
      'p5.jsによる描画表現の理解を目的に制作しました。AI支援ツールも活用しながらコードを検証・調整し、動作原理の理解を深めています。',
    tags: ['React', 'Next.js'],
  },
  {
    title: 'ユーザー管理アプリ',
    ...
    focus:
      'フォーム編集操作のわかりやすさを意識し、状態管理とバリデーションを整理しました。ローカルストレージ保存で更新内容を保持できるようにしています。',
    tags: ['React', 'Next.js'],
  },
  {
    title: 'お問い合わせフォーム',
    ...
    focus:
      '実務で再利用できることを想定し、入力チェックとエラー表示の分かりやすさを重視して設計しました。',
    tags: ['React', 'Next.js'],
  },
  {
    title: 'ヘアサロンVDOサイト',
    ...
    focus:
      'サロンの雰囲気が伝わるビジュアル設計と、GSAPを用いたアニメーション演出で閲覧体験を向上させました。レスポンシブ表示にも対応しています。',
    tags: ['React', 'Next.js'],
  },
];
